...
namespace Meta
{
    ...
    /// </summary>
    public class HandsProvider : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            handManager.OnHandDataAppear += OnHandDataAppear;
            handManager.OnHandDataDisappear += OnHandDataDisappear;

            handManager.RegisterHandsProivder(this);
        }
        ...
        public class Settings
        {
            ...
            [Range(0, 0.15f)]
            [SerializeField]
            private float _palmRadiusNear = 0.065f;

            [Range(0, 0.15f)]
            [SerializeField]
            private float _palmRadiusFar = 0.085f;
